<x-layout>
    ...
    <section class="list">
        <div class="list_header">
            <select name="" class="list_header-select" onchange="changeTaskStatusFilter(this)">
...
<script>
    async function taskUpdate(element) {
        ...
        let rawResult = await fetch(url, {
            ...
            body: JSON.stringify({status, idTask, _token:'{{csrf_token()}}'})
        });
